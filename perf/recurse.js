...
["_main","_memory","_foo","_bar","___indirect_function_table","__embind_initialize_bindings","_fflush","___start_em_js","___stop_em_js","onRuntimeInitialized"].forEach((prop) => {
...
function bar(count) { if (count > 0) { _foo(count - 1); } }
...
var ___start_em_js = Module['___start_em_js'] = 68652;
var ___stop_em_js = Module['___stop_em_js'] = 68707;
